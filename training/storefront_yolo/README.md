...
TensorRT engines are generated by `training/storefront_yolo/export_yolo.py` with
`--format engine`. Build them on the deployment GPU/Jetson, not copied from the
4080 server:
