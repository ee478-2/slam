                                    ...
                                    size_t &empty_count)
{
  ...
  for (unsigned i = 0; i < npoints; ++i) {
    ...
    double local_x = scan->points[i].z; // currently, wrong transform. you need to fix this!
    double local_y = -(scan->points[i].x); // currently, wrong transform. you need to fix this!
    double local_z = -(scan->points[i].y); // currently, wrong transform. you need to fix this!
